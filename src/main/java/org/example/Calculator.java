...
public class Calculator {
    ...
    public double grossMinusPensionUnemployment(double grossSalary) {
    ...
    public double netSalaryCalculation(double grossSalary, double taxFreeIncome) {
        double result = grossMinusPensionUnemployment(grossSalary) ;
        return result - (result * (INCOME_TAX_RATE / 100));
